...
## [16.5.0](https://github.com/hougesen/topgrade/compare/v16.4.2...v16.5.0) - 2025-11-22

### Added

- *(mise)* add support for parallel job configuration in mise ([#1548](https://github.com/hougesen/topgrade/pull/1548))
- *(brew)* add Homebrew cask support for Linux ([#1539](https://github.com/hougesen/topgrade/pull/1539))
- *(mise)* add mise configuration options for bump and interactive modes ([#1546](https://github.com/hougesen/topgrade/pull/1546))

### Other

- *(deps)* update rust crate indexmap to v2.12.1 ([#1550](https://github.com/hougesen/topgrade/pull/1550))
- *(deps)* update actions/checkout action to v6 ([#1551](https://github.com/hougesen/topgrade/pull/1551))
- Add metadata to Python package for PyPI ([#1549](https://github.com/hougesen/topgrade/pull/1549))
- *(installation)* update copr repo info in readme ([#1545](https://github.com/hougesen/topgrade/pull/1545))
